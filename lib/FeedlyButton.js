  ...
  _createClass(FeedlyButton, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('img', { src: this.state.image, alt: 'follow us in feedly', style: { width: this.state.width, height: this.state.height } })
      );
    }
  }]);
